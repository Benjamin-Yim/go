...
type mspan struct {
	_    sys.NotInHeap
	next *mspan     // next span in list, or nil if none // 双向链表中 指向下一个
	prev *mspan     // previous span in list, or nil if none  双向链表中 指向前一个。
	...
	freeindex uint16 // 表示分配到第几个块
	// TODO: Look up nelems from sizeclass and remove this field if it
	// helps performance.
	nelems uint16 // number of object in the span. span 中对象的数量,表示有多少个可供分配。number of object in the span.
